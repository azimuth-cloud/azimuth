...
class HardDisk(namedtuple('HardDiskProps', ['name', 'size'])):
    """
    Represents a hard disk attached to a machine.
...
class Machine(namedtuple('MachineProps', ['id', 'name', 'status',
    ...
    .. py:attribute:: disks
        ...
        A tuple of :py:class:`HardDisk` objects representing the disks attached
        to the machine.
