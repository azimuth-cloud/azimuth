    ...
    path(
        ...
        include(
            [
                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                "<id:image>/", views.image_details, name="image_details"
                            ),
                        ]
                    ),
                ),
                                        ...
                                        path(
                                            ...
                                            include(
                                                [
                                                    path(
                                                        "",
                                                        views.machine_firewall_rules,
                                                        name="machine_firewall_rules",
                                                    ),
                                                    path(
                                                        "<id:rule>/",
                ...
                path(
                    "kubernetes_cluster_templates/",
                    include(
                        [
                            path(
                                "",
                                views.kubernetes_cluster_templates,
                                name="kubernetes_cluster_templates",
                            ),
                            path(
                                "<id:template>/",
                ...
                path(
                    "kubernetes_app_templates/",
                    include(
                        [
                            path(
                                "",
                                views.kubernetes_app_templates,
                                name="kubernetes_app_templates",
                            ),
                            path(
                                "<id:template>/",
                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                "_schedule/",
                                views.cluster_schedule_new,
                                name="cluster_schedule_new",
                            ),
                            path(
                                "<id:cluster>/",
                                include(
                                    [
                                        path(
                                            "",
                                            views.cluster_details,
                                            name="cluster_details",
                                        ),
                                        path(
                                            "_schedule/",
                                            views.cluster_schedule_existing,
                                            name="cluster_schedule_existing",
                                        ),
                                        path(
                                            "patch/",
                                            views.cluster_patch,
